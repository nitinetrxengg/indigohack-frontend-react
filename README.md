...
- Define a development env by creating a file using `touch .env.development.local`. If no such file is defined `npm start` will assume production env. See `package.json` to understand the config
